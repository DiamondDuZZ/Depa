            ...
            <div className="flex gap-4">
              {mentorData === null ? (
                <button
                  ...
                  onClick={() => handlelAddmentorModal(task)}
                >
                  {/* ไอคอน + */}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              {users2.length > 0 ? (
                users2.map((user2, index) => (
                  ...
                  >
                    ...
                    <button
                      className="ml-auto flex items-center justify-center w-10 h-10 rounded-full border-2 border-red-500 text-red-500 transition hover:bg-red-500 group"
                      onClick={() => handleOpenOtherModal(user2.user_id)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
            ...
            {users2.length < 4 && (
              <div className="w-full p-4">
                ...
                >
                  ...
                  {allUsers
                    .filter((user) => !userIds.includes(user.user_id)) // ไม่ให้เลือกซ้ำ
                    .map((user) => (
        ...
        <div>
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-[#33AC5E] text-white font-medium py-2 px-5 shadow-sm rounded-full transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-md"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          <table className="table-auto w-full bg-white shadow-md rounded-b-2xl">
            <thead>
              <tr className="bg-[#0C2F53] text-white text-center">
                ...
                <th className="py-3 px-4">ประเมิน</th>
                    ...
                    {menuOpen === taskIndex && (
                      ...
                      >
                        <ul className="py-2">
                          {/* เพิ่มคำอธิบาย */}
                          {/* <li
                            className="flex items-center px-4 py-2 hover:bg-[#F5F5F5] text-[#0095FF] cursor-pointer"
                            onClick={() => handleOpenSendModal(task)}
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="20"
                            ...
                            <p className="ml-1">เพิ่มคำอธิบาย</p>
                          </li> */}
          ...
          <tbody>
            {basicCourses.map((course, index) => (
              ...
              >
                ...
                <td className="py-3 px-4 flex items-center justify-center">
                  <span className="flex items-center justify-center drop-shadow-lg bg-white text-[#686868] rounded-full py-2 px-0.5 h-[40px] w-[180px]">
                    <span
                      className={`mr-2 flex items-center justify-center w-6 h-6 rounded-full text-white ${
          ...
          <tbody>
            {activities.map((activity, index) => (
              ...
              >
                ...
                <td className="py-3 px-4 flex items-center justify-center">
                  <span className="flex items-center justify-center drop-shadow-lg bg-white text-[#686868] rounded-full py-2 px-0.5 h-[40px] w-[150px]">
                    <span
                      className={`mr-2 flex items-center justify-center w-6 h-6 rounded-full text-white ${
