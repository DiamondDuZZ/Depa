...
const section1 = ({ formData, handleInputChange, handleFileChange, today }) => {
  return (
    <div>
      <div>
        <h2 className="text-2xl font-bold text-navy-blue ml-4 mb-6">
          ข้อมูลส่วนบุคคล PERSONAL DETAILS
        </h2>
        <div className="grid grid-cols-3 gap-8 ml-16">
          <div>
            <label className="block text-navy-blue font-medium mb-2">
              ชื่อ Name in Thai
            </label>
            <select
              name="title_name"
              ...
              className="w-[280px] h-[31px] pl-2 pb-1 border-b border-gray-100 focus:border-blue-500 outline-none text-gray-700  "
          ...
          <div>
            ...
            <input
              ...
              className="w-[350px] h-[31px] pl-2 mt-6 pb-1 border-b border-gray-300 focus:border-blue-500 outline-none placeholder-gray-400 "
            />
          </div>
          <div>
            <label className="block text-gray-700 font-medium mb-2"></label>
          ...
          <div>
            ...
            <select
              ...
              onChange={handleInputChange} // อัปเดต formData เมื่อเลือกใหม่
              className="w-[280px] h-[31px] pl-2 pb-1 border-b border-gray-300 focus:border-blue-500 outline-none text-gray-700"
          ...
          <div>
            ...
            <input
              ...
              className="w-[350px] h-[31px] pl-2 pb-1 border-b border-gray-300 focus:border-blue-500 outline-none placeholder-gray-400"
            />
          </div>
          <div>
            <label className="block text-navy-blue font-medium mb-2 ">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange} // อัปเดต formData เมื่อเลือกใหม่
              placeholder="Please enter your name *"
              className="w-[280px] h-[31px] pl-2 pb-1 border-b border-gray-300 focus:border-blue-500 outline-none placeholder-gray-400"
            />
          </div>
          <div>
            <label className="block text-navy-blue font-medium mb-2">
        ...
        <div className="ml-2.5">
          <div className="w-full ml-14">
            ...
            <input
              ...
              name="files"
              accept=".pdf,.doc,.docx"
              className="w-[600px] h-[31px] pl-2 pb-9 border-b border-gray-300 focus:border-blue-500 outline-none placeholder-gray-400"
